...
% Modified to meet Tulane University's thesis/dissertation format requirements
%
% Class license:
...
\newcommand{\classname}{tulane_thesis}
...
%----------------------------------------------------------------------------------------
%--------------------------------
% New frontmatter page style to ensure page number center footer
%--------------------------------
\RequirePackage[markcase=used]{scrlayer-scrpage}
\providepairofpagestyles{frontmatter}{%
...
\providepairofpagestyles{thesisSimple}{%
	...
	%\ihead{\headmark}% Inner header (Chapter title) %%%%%%%%% Comment to remove header line
...
%----------------------------------------------------------------------------------------
%	ABSTRACT PAGE DESIGN (ALTERNATIVE)
%----------------------------------------------------------------------------------------

\usepackage{xcolor}
\colorlet{mdtRed}{red!50!black}
\newcommand{\abstractname}{Abstract}
\providecaptionname{american,australian,british,canadian,english,newzealand,UKenglish,USenglish} {\abstractname}{Abstract} % abstract text for English countries
\providecaptionname{german,ngerman,austrian,naustrian}{\abstractname}{Danksagung} % abstract text for Germanic countries
