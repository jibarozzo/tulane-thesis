...
\makeatother
\usepackage{xcolor}
\usepackage[inner=2in,outer=1in,top=1in,bottom=1in,headsep=1pt,headheight=1pt,footskip=33pt,heightrounded]{geometry}
...
\pagenumbering{goobledegook}
\pagenumbering{roman}
\usepackage{scrlayer-scrpage}
\ohead{\pagemark}      % Page number in the outer (right) header
...
\usepackage{sectsty}
\usepackage{titlesec}
\titleformat{\chapter}{\Huge\bfseries\flushleft}{}{0pt}{\fontsize{24}{20}\selectfont}
\titlespacing*{\chapter}{0pt}{0ex plus 1ex minus .2ex}{6ex plus .2ex}
\titlespacing*{\section}{0pt}{10ex plus 1ex minus .2ex}{6ex plus .2ex}
\titlespacing*{\subsection}{0pt}{10ex plus 1ex minus .2ex}{6ex plus .2ex}
\sectionfont{\fontsize{24}{20}\selectfont\flushleft}
\subsectionfont{\fontsize{24}{20}\selectfont\flushleft}
\makeatletter
\makeatother
\makeatletter
...
\let\mainmatter\relax\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, breakable, enhanced, borderline west={3pt}{0pt}{shadecolor}, interior hidden, frame hidden, sharp corners]}{\end{tcolorbox}}\fi
