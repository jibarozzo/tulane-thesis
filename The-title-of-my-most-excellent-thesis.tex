...
{\centering
  ...
  %\vspace{3ex}
  {\bfseries\large Invalid
Date \par} %Uncomment to inclide date below author name
  \vspace{12ex}
  %
  \vspace{12ex}
  % Signature Line
...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, interior hidden, boxrule=0pt, breakable, enhanced, borderline west={3pt}{0pt}{shadecolor}, sharp corners]}{\end{tcolorbox}}\fi
...
See Appendix~\ref{sec-more-results} for more detailed results
