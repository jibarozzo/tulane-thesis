...
\usepackage{xcolor}
\usepackage[inner=2in,outer=1in,top=1in,bottom=1in,headsep=1pt,headheight=1pt,footskip=33pt,ignorehead,ignorefoot,heightrounded]{geometry}
...
\renewcommand{\arraystretch}{0.5} % Adjust the value as needed
\usepackage{sectsty}
\usepackage{titlesec}
...
\titlespacing*{\section}{0pt}{10ex plus 1ex minus .2ex}{3ex plus .2ex}
\titlespacing*{\subsection}{0pt}{10ex plus 1ex minus .2ex}{1ex plus .2ex}
...
\let\mainmatter\relax\pagenumbering{roman} % Roman numerals for Title to Intro pages
...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, enhanced, boxrule=0pt, sharp corners, interior hidden, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
